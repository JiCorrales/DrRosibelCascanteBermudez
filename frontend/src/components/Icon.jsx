...
const PATHS = {
  ...
  whatsapp: (
    <>
      <path d="M8 1.5C4.4 1.5 1.5 4.4 1.5 8c0 1.15.3 2.23.83 3.17L1.5 14.5l3.43-.82c.91.5 1.96.78 3.07.78 3.6 0 6.5-2.9 6.5-6.5S11.6 1.5 8 1.5z" />
      <path d="M5.4 5.2c-.15-.05-.3 0-.4.1-.1.15-.45.5-.45 1.2 0 .7.5 1.4.55 1.5.05.1 1 1.55 2.45 2.1.7.25 1.25.4 1.7.5.5.1.95.05 1.3-.05.4-.15.95-.45 1.1-.85.15-.4.15-.75.1-.85-.05-.1-.15-.15-.35-.25-.2-.1-1.05-.5-1.2-.55-.15-.05-.3-.05-.4.1-.15.15-.35.45-.45.55-.1.1-.2.1-.35.05-.2-.1-.75-.3-1.45-.95-.55-.5-.9-1.05-1-1.25-.1-.2 0-.3.1-.4l.3-.35c.1-.1.15-.2.2-.3.05-.1.05-.2 0-.3-.05-.1-.4-1-.55-1.35z" />
    </>
  ),
};
